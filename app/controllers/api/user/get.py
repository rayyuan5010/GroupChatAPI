...
class UserLogin(Resource):
    ...
    def post(self):
        try:
            ...
            userCount = User.query.filter_by(
                email=email).filter_by(password=password).count()
            if userCount > 0:
            ...
            return APIReturn(status=False, errorCode="0x0000000202", message=str(e.__dict__['orig']))
